...
class AssistOverlayActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ✅ Transparent background and no transition flicker
    ...
    private fun applyTheme() {
        ...
        val cardBackground = ContextCompat.getDrawable(
            this,
            if (isDark) R.drawable.overlay_background_dark else R.drawable.overlay_background_light
        )
        overlayCard?.background = cardBackground

        val voiceBg = ContextCompat.getDrawable(
            this,
    ...
    private fun toggleListening() {
        ...
        val color = if (isListening)
            ...
            val isDark = (resources.configuration.uiMode and
                    Configuration.UI_MODE_NIGHT_MASK) ==
                    Configuration.UI_MODE_NIGHT_YES
            if (isDark) Color.WHITE else Color.parseColor("#333333")
        }
